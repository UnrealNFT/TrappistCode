...
function App() {
  const [selectedAgent, setSelectedAgent] = useState<'groq' | 'kimi' | 'claude' | 'kimi-wavespeed'>('groq')
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', backgroundColor: '#1e1e1e', color: '#cccccc', fontFamily: 'Consolas, monospace', overflow: 'hidden' }}>
      <div style={{ height: '36px', backgroundColor: '#323233', display: 'flex', alignItems: 'center', padding: '0 12px', fontSize: '13px', flexShrink: 0 }}>
        TrappistAI
      ...
      <div style={{ display: 'flex', flex: 1, minHeight: 0, overflow: 'hidden' }}>
        <div style={{ width: '280px', backgroundColor: '#252526', borderRight: '1px solid #3e3e42', flexShrink: 0, overflow: 'auto' }}>
          <GitHubPanel
      ...
      <div style={{ height: '28px', backgroundColor: '#007acc', color: 'white', fontSize: '12px', display: 'flex', alignItems: 'center', padding: '0 16px', gap: '16px', flexShrink: 0 }}>
